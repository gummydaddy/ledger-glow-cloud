...
export type VendorFormValues = z.infer<typeof FormSchema>;
...
export function VendorFormDialog({ open, onOpenChange, initialData, onSubmit }: VendorFormDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>{initialData ? "Update vendor details" : "Create a new vendor"}</DialogDescription>
        </DialogHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="email" placeholder="name@vendor.com" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
